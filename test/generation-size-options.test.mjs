...
test("size options are filtered by ratio and keep previously supported sizes intact", () => {
  ...
  assert.deepEqual(portrait, ["auto", "1024x1280", "1280x1600", "1600x2000", "1536x1920", "2048x2560"]);
  assert.deepEqual(poster, ["auto", "768x1024", "1152x1536", "1536x2048", "1008x1344", "2064x2752"]);
  assert.deepEqual(widescreen, ["auto", "1280x720", "1536x864", "2048x1152", "1792x1008", "2816x1584", "3584x2016"]);
  assert.deepEqual(story, ["auto", "720x1280", "864x1536", "1152x2048", "1008x1792", "1584x2816", "2016x3584"]);
});
