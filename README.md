...
`auto` 会使用“默认”列的尺寸；手动选择分辨率时，按对应比例行横向选择。

| 比例 | 默认 | 分辨率 1 | 分辨率 2 | 分辨率 3 | 分辨率 4 | 分辨率 5 | 分辨率 6 | 分辨率 7 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `1:1` | `1536x1536` | `1024x1024` | `1536x1536` | `2048x2048` | `2880x2880` | - | - | - |
| `5:4` | `1600x1280` | `1280x1024` | `1600x1280` | `2000x1600` | `3200x2560` | - | - | - |
| `9:16` | `864x1536` | `720x1280` | `864x1536` | `1152x2048` | `1008x1792` | `1584x2816` | `2016x3584` | `2160x3840` |
| `21:9` | `1680x720` | `1344x576` | `1680x720` | `2016x864` | `4368x1872` | - | - | - |
| `16:9` | `1536x864` | `1280x720` | `1536x864` | `2048x1152` | `1792x1008` | `2816x1584` | `3584x2016` | `3840x2160` |
| `4:3` | `1536x1152` | `1024x768` | `1536x1152` | `2048x1536` | `3264x2448` | - | - | - |
| `3:2` | `1536x1024` | `1152x768` | `1536x1024` | `2016x1344` | `3504x2336` | - | - | - |
| `4:5` | `1280x1600` | `1024x1280` | `1280x1600` | `1600x2000` | `1536x1920` | `2048x2560` | `2560x3200` | - |
| `3:4` | `1152x1536` | `768x1024` | `1152x1536` | `1536x2048` | `1008x1344` | `2064x2752` | `2448x3264` | - |
| `2:3` | `1024x1536` | `768x1152` | `1024x1536` | `1344x2016` | `2336x3504` | - | - | - |
