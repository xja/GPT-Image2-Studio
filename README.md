...
`auto` 会使用“默认”列的尺寸；手动选择分辨率时，按对应比例行横向选择，真实分辨率从大到小排列。

| 比例 | 默认 | 分辨率 1 | 分辨率 2 | 分辨率 3 | 分辨率 4 | 分辨率 5 | 分辨率 6 | 分辨率 7 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `1:1` | `1536x1536` | `2880x2880` | `2048x2048` | `1536x1536` | `1024x1024` | - | - | - |
| `5:4` | `1600x1280` | `3200x2560` | `2560x2048` | `2000x1600` | `1600x1280` | `1280x1024` | - | - |
| `9:16` | `864x1536` | `2160x3840` | `2016x3584` | `1584x2816` | `1152x2048` | `1008x1792` | `864x1536` | `720x1280` |
| `21:9` | `1680x720` | `4368x1872` | `2016x864` | `1680x720` | `1344x576` | - | - | - |
| `16:9` | `1536x864` | `3840x2160` | `3584x2016` | `2816x1584` | `2048x1152` | `1792x1008` | `1536x864` | `1280x720` |
| `4:3` | `1536x1152` | `3264x2448` | `2752x2064` | `2048x1536` | `1536x1152` | `1024x768` | - | - |
| `3:2` | `1536x1024` | `3504x2336` | `3072x2048` | `2016x1344` | `1536x1024` | `1152x768` | - | - |
| `4:5` | `1280x1600` | `2560x3200` | `2048x2560` | `1600x2000` | `1536x1920` | `1280x1600` | `1024x1280` | - |
| `3:4` | `1152x1536` | `2448x3264` | `2064x2752` | `1536x2048` | `1152x1536` | `1008x1344` | `768x1024` | - |
| `2:3` | `1024x1536` | `2336x3504` | `2048x3072` | `1344x2016` | `1024x1536` | `768x1152` | - | - |
