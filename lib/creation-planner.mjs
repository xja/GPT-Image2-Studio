...
const CREATION_ROLE_INTENT_INSTRUCTIONS = {
  ...
  "social-proof":
    "Role intent: make this a photoreal real-use recommendation image, not a product-only graphic. Show an actual user or user-result proof with the product. For fishing lures or bait, show an angler using it and the caught fish; for ladders, show a real person safely standing on or using the ladder.",
  "material-closeup":
