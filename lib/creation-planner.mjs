...
const CREATION_CONTENT_CATEGORY_PATTERNS = {
  ...
  benefit: [/benefit|selling|power|noise|portable|easy|\u5356\u70b9|\u5438\u529b|\u4f4e\u566a|\u5f3a\u52b2|\u8f7b\u4fbf|\u591a\u573a\u666f|\u9002\u7528|\u7701\u529b|\u9ad8\u6548/i],
  material: [/material|texture|surface|structure|detail|filter|nozzle|fabric|finish|\u6750\u8d28|\u7eb9\u7406|\u8d28\u611f|\u8868\u9762|\u7ed3\u6784|\u7ec6\u8282|\u6ee4\u82af|\u5438\u5634|\u505a\u5de5/i],
  scene: [/scene|usage|context|environment|lifestyle|car interior|outdoor|indoor|\u4f7f\u7528\u573a\u666f|\u573a\u666f|\u8f66\u5185|\u6237\u5916|\u529e\u516c\u5ba4|\u65c5\u884c|\u53a8\u623f|\u751f\u6d3b/i],
  usage: [/step|setup|install|operation|how to|\u4f7f\u7528\u6b65\u9aa4|\u6b65\u9aa4|\u5b89\u88c5|\u64cd\u4f5c|\u6e05\u6d01|\u7ec4\u88c5/i],
  dimensions: [/dimension|size|spec|capacity|height|width|\bcm\b|\bmm\b|\bg\b|\boz\b|\u5c3a\u5bf8|\u89c4\u683c|\u5bb9\u91cf|\u9ad8\u5ea6|\u5bbd\u5ea6|\u91cd\u91cf/i],
  package: [/package|bundle|included|accessor|storage bag|\u5305\u88c5|\u6e05\u5355|\u5957\u88c5|\u6536\u7eb3\u888b|\u914d\u4ef6/i],
  trust: [/trust|quality|proof|safe|cert|warranty|durable|review|reliable|\u4fe1\u4efb|\u8d28\u91cf|\u5b89\u5168|\u8ba4\u8bc1|\u8d28\u4fdd|\u8010\u7528|\u8bc4\u4ef7|\u53e3\u7891|\u9632\u6c34/i],
};
...
function buildCreationRoleSourceFocus({
  ...
  const description = formatCreationContentFacts(descriptionFacts) || descriptionLine;
...
function buildCreationSkuPrompt({
  ...
  return [
    ...
    "Change the background from the uploaded white or plain product photo into a clean premium ecommerce background with polished commercial lighting.",
    ...
    logoOptions?.enabled
      ...
      : "",
    "Ecommerce SKU image quality, clear centered subject, clean background separation, realistic product details.",
