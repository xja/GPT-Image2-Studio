    ...
    reference_roles: {
      ...
      items: {
        ...
        properties: {
          ...
          role: {
            type: "string",
            enum: ["product", "package", "material", "dimensions", "scene", "style", "other"],
            description: "推荐的套图参考用途。",
          },
          note: {
            type: "string",
            description: "这张参考图应该影响生成结果的重点说明，使用简体中文。若 role=dimensions，必须逐项写入可辨认的具体规格原文，例如：型号 F4J16、长度 13cm、重量 42g、钩号 2#。",
          },
        },
      },
