...
const ITEM_SUPPORTING_REFERENCE_ROLES = {
  ...
  "review-qa": ["material"],
  "feature-callout": ["material", "dimensions", "usage", "style"],
  "variant-matrix": ["style"],
  compatibility: ["material", "dimensions", "usage", "style"],
  "care-guide": ["material", "usage", "style"],
  "brand-story": ["material", "scene", "style"],
  "image-decomposition": ["material", "dimensions", "usage", "style"],
};
